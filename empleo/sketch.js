...
function draw() {
  ...
  //según el boton del año se le asigna un valor a las varibles de la equivalencia y al tamaño del estadio
...
fill(255);
  rect(3,35,width,45);
  fill(0);
  text("¿Cuántos estadios el Campín se llenarían con el número de empleados del sector construcción por año y por género?", 10,50, width,200);
